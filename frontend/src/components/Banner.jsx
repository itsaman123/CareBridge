...
const Banner = () => {
    ...
    return (
        <section className='py-20'>
            <div className='relative overflow-hidden bg-gradient-hero rounded-3xl shadow-large border border-cyan-500/30'>
                {/* Background Pattern */}
                ...
                <div className='relative flex flex-col lg:flex-row items-center px-8 md:px-12 lg:px-16 py-12 md:py-16 lg:py-20'>
                    ...
                    {/* ------- Left Side ------- */}
                    <div className='lg:w-1/2 text-cyan-300 z-10 mb-8 lg:mb-0'>
                        <div className='space-y-6'>
                            <div className='space-y-4'>
                                ...
                                <p className='text-lg md:text-xl text-cyan-400/80 max-w-lg leading-relaxed'>
                            ...
                            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                                <div className='flex items-center gap-3 bg-cyan-500/10 backdrop-blur-sm rounded-xl p-3 border border-cyan-500/30'>
                                    <div className='w-10 h-10 bg-gradient-primary rounded-lg flex items-center justify-center'>
                                        <span className='text-black text-lg font-bold'>⚡</span>
                                    </div>
                                    <div>
                                        <p className='font-semibold text-sm text-cyan-300'>Instant Booking</p>
                                        <p className='text-xs text-cyan-400/70'>Quick & Easy</p>
                                    </div>
                                </div>
                                <div className='flex items-center gap-3 bg-cyan-500/10 backdrop-blur-sm rounded-xl p-3 border border-cyan-500/30'>
                                    <div className='w-10 h-10 bg-gradient-primary rounded-lg flex items-center justify-center'>
                                    ...
                                    <div>
                                        <p className='font-semibold text-sm text-cyan-300'>Verified Doctors</p>
                                        <p className='text-xs text-cyan-400/70'>100% Trusted</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className='lg:w-1/2 relative'>
                        <div className='relative'>
                            ...
                            <img
                                className='w-full max-w-md mx-auto lg:ml-auto rounded-2xl shadow-2xl border-4 border-cyan-500/30'
                            ...
                            <div className='absolute -bottom-6 -left-6 glass rounded-2xl p-4 shadow-large border border-cyan-500/30'>
                                <div className='flex items-center gap-3'>
                                    ...
                                    <div>
                                        ...
                                        <p className='text-xs text-cyan-400/70'>Happy Patients</p>
                                    </div>
                                </div>
                            </div>
                        </div>
